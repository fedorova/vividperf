...
#pin.sh  -t $CUSTOM_PINTOOLS_HOME/obj-intel64/straggler-catcher.so -s ./my_script.sh -- perf record ${WT_HOME}/bench/wtperf/wtperf -O ${WT_HOME}/../bench/wtperf/runners/evict-btree.wtperf
